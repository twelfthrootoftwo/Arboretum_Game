...
import comp1110.ass2.gui.GUIPosition;
...
public class ScoreText extends Group {
    ...
    public ScoreText(Player player, int xSizeArbor, int ySizeArbor, int xPosArbor, int yPosArbor, boolean inverse) {
        this.player=player;
...
//        scoreBox.setFill(Color.WHITE);
        ...
        if (inverse) scoreText.setX(xPosArbor-ARBOR_X_SIZE*2.7);
