...
public class Arbor {
     ...
     * Resets the scoring map to null first, so any existing map will be overwritten. This assumes that the arbor can't be modified, only expanded (in which case all the old information will be recalculated).
     */
